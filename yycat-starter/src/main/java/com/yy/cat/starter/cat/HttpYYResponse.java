...
/**
 * YYResponse规范的默认实现
 * 基于Netty的ChannelHandlerContext对象实现响应回写
 */
public class HttpYYResponse implements YYResponse {

    private HttpRequest request;
    private ChannelHandlerContext context;
    public HttpYYResponse(HttpRequest request, ChannelHandlerContext ctx) {
